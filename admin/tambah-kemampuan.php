...
if (isset($_POST['tambah'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO kemampuan (nama_kemampuan, bulan) VALUES ('$nama_kemampuan', '$level'");
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete = mysqli_query($koneksi, "DELETE FROM profil WHERE id='$id'");
...
<body>
    <h2>Tambah Profil</h2>
    <form action="kemampuan.php" method="post">
        <div class="form-group">
            <label for="nama_kemapuan">Nama Kemampuan</label>
